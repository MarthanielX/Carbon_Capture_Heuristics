...
public class Single_Edge_CCS_Network {
    ...
    public Single_Edge_CCS_Network(int n, ArrayList<Terminal> sources, ArrayList<Terminal> sinks, ArrayList<SingleEdge> edge_list) {
        this.n = n;
        this.sources = sources;
        this.sinks = sinks;
        errorCheckTerminals();
    ...
    public Single_Edge_Flow_Network convertToAffineCostFlowNetwork() {
        ...
        return new Single_Edge_Flow_Network(n + 2, new_matrix);
    }
